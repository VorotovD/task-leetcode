...
/*
 * Метод решения:
 * 1. Найти бинарным поиском два ближайших к х кандидата в результирующую коллекцию так, что a <= x <= b и a < b ,
 ...
 * ближайший к x кандидат попадает в результурующий список. На его место встает следующий по порядку элемент массива
